          ...
          children: [
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                height: 50,
                child: Text("Please Enter Code",style: appThemeData.textTheme.titleLarge,textAlign: TextAlign.center,),
              ),
            ),
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(width: 1,color: AppLightColor.fillButton),borderRadius: BorderRadius.all(Radius.circular(25))
                ),
                child: TextFormField(
                  style: TextStyle(height: 1,fontWeight: FontWeight.bold,color: Colors.blue),
