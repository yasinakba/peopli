      ...
      children: [
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              ...
              child: RichText(
                text:TextSpan(
                    text: "Dont Have Account? ",style: appThemeData.textTheme.headlineLarge,
                    children: [

                      TextSpan(
                          text: " Signup ",style: appThemeData.textTheme.headlineLarge!.copyWith(color: AppLightColor.textBlueColor),
                      ),
        ...
        Align(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: InkWell(
                  onTap: (){Get.toNamed(NamedRoute.routeForgetPassword);},
                  child: Text(" Forgot your password? ",style: appThemeData.textTheme.headlineLarge!.copyWith(color: AppLightColor.textBlueColor),)),
            )),
      ],
    ));
  }
