                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(width: 130.w, child: Text("David Garet ",style: appThemeData.textTheme.labelMedium,textAlign: TextAlign.start,)),
                              SizedBox(width: 130.w,height: 15,child: Align( alignment: Alignment.bottomLeft,    child: Icon(Icons.circle,color: AppLightColor.negativeFill,size: 10,))),
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                          ...
                          child: AutoSizeText('Your Power" each peaked within the top 10 in the US and UK. Eilish has received several accolades',maxLines: 3,style:appThemeData.textTheme.labelLarge,textAlign: TextAlign.start ,)),
                    ),
                  ],
                ),
              ),
