...
class PostFirstScreen extends GetView<LoginConteoller> {
  const PostFirstScreen({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                              width: 20.w, height: 20.w, child: Text("2.0")),
                        ),
                      ],
                    ),
                  )
          ...
          Padding(
            padding:
                const EdgeInsets.only(left: 12, right: 20, bottom: 5, top: 5),
            child: Row(
              children: [
                Icon(Icons.location_on),
                AutoSizeText(
                  'Pais School, Versue Street, Paris',
                  maxLines: 3,
