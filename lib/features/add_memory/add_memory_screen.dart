...
class AddMemoryScreen extends GetView<AddMemoryController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          GetBuilder<AddMemoryController>(builder: (controller) => Column(
                      children: [
                        //divider
                        Container(
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Padding(
                              ...
                              child: Text("AddMemory",style: appThemeData.textTheme.bodyLarge,),
                            ),
                          ],
                        ),
                        //Radio
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 20,top: 10),
                              child: Text("Location: ",style: appThemeData.textTheme.bodyLarge,),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 20,top: 5),
                              child: InkWell(child: TextFiildMemory(labelText: 'Location', iconT: Icon(Icons.location_on), onPressed: () {  },)),
                            )
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Padding(
                              ...
                              child: Text("Date: ",style: appThemeData.textTheme.bodyLarge,),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 35,top: 25),
                              child: InkWell(child: TextFiildMemory(labelText: '2024/02/02', iconT: Icon(Icons.date_range_outlined),onPressed: () {  })),
                            )
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Padding(
                              ...
                              child: Text("Subject: ",style: appThemeData.textTheme.bodyLarge,),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 20,top: 25,),
                              child: InkWell(child: TextFiildMemory(labelText: 'Subject...', iconT: Icon(Icons.subject),onPressed: () {  })),
                            )
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(color: AppLightColor.strokeRectangleType,width: 1),
                              ...
                              child: SizedBox(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    ...
                                    Text("Add photo or video:",style: appThemeData.textTheme.bodyLarge,),
                                    Text("Art-L01.jpg",style: appThemeData.textTheme.bodySmall,),
                                  ],
                                ),
                              ),
                            ),
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                                    ...
                                    InkWell(
                                        ...
                                        child: Text("Add ",style: appThemeData.textTheme.bodyLarge,)),
                        ...
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: CustomElevatedButton(onPressed: (){Get.toNamed(NamedRoute.routePersonAddScreen);}, textColor: AppLightColor.withColor, color: AppLightColor.textBlueColor, title: "Submit", height: 29.h, width: 75.w)),
                        )
