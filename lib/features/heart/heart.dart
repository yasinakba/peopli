                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SizedBox(width: double.infinity,
                                        child: Text("Sofia J. West",
                                          style: appThemeData.textTheme.headlineLarge,
                                          textAlign: TextAlign.start,)),
                                    SizedBox(width: double.infinity,
                                        child: Text("wise president of France",
                                    ...
                                    SizedBox(width: double.infinity,
                                        child: Text("1975 - now",
                                          ...
                                          textAlign: TextAlign.start,)),
                                    SizedBox(width: double.infinity,
                                        child: Text("Avenue 13, Bond Pavilion ...",
                                          style: appThemeData.textTheme.bodyLarge,
                                          textAlign: TextAlign.start,
                                          maxLines: 1,)),
                              ...
                              children: [
                                ...
                                SizedBox(width: 130.w,
                                    ...
                                    child: Align(
                                      ...
                                      Icons.circle, color: AppLightColor.negativeFill,
                                      size: 10,))),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            left: 12, right: 20, bottom: 5, top: 5),
                        child: Row(
                          children: [
                            Icon(Icons.location_on),
                            AutoSizeText(
                              'Pais School, Versue Street, Paris', maxLines: 3,
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                            ...
                            height: 141.h,
                            child: Image.asset(
                              AppAssetsJpg.postImage, fit: BoxFit.cover,)),
                      ),
                      //Like && share
                      Padding(
                            ...
                            Row(
                              children: [
                                ...
                                InkWell(
                                  onTap: () {},
                                  child: SizedBox(
                                      width: 17.w, height: 17.h, child: Image.asset(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    "123", style: appThemeData.textTheme.bodyMedium,),
                                ),
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: SizedBox(
                                      width: 17.w,
                                      height: 17.w,
                                      child: Image.asset(AppAssetsPng.iconLHeart,
                                        color: AppLightColor.postNavbar,)),
                                ),
                            ...
                            Row(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 4),
                                  child: Text(
                                    "10:45", style: appThemeData.textTheme.bodyMedium,),
                                ),
